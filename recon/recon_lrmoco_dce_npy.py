...
# -*- coding: utf-8 -*-
"""
Created on Thu May 19 21:52:53 2022

@author: ftan1
"""

# low resolution recon
import argparse 
...
if __name__ == '__main__':
    ...
    gating = np.real(np.load(fname+'/resp.npy'))
